...
End Rem
Function LzmaUncompress( dest:Byte Ptr, destLen:Size_T Var, src:Byte Ptr, srcLen:Size_T Var ) = "Lzma86_Decode"
...
End Rem
Function LzmaCompress3( dest:Byte Ptr, destLen:Size_T Var, src:Byte Ptr, srcLen:Size_T, level:Int, dictSize:UInt = LZMA_DICT_SIZE ) = "_LzmaCompress"

End Extern

' Dictionary size in bytes (16MB)
Const LZMA_DICT_SIZE:UInt = $1000000

Rem
bbdoc: Compress a block of data at default compression level
end rem
Function LzmaCompress( dest:Byte Ptr, destLen:Size_T Var, src:Byte Ptr, srcLen:Size_T )
...
Compression level should be in the range 1-9 with 9 the maximum compression.
End Rem
Function LzmaCompress2( dest:Byte Ptr, destLen:Size_T Var, src:Byte Ptr, srcLen:Size_T, level:Int )
